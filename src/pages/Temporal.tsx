...
import directorsMin from "../assets/images/temporal/directors-min.webp";
import directors from "../assets/images/temporal/directors.webp";
import bootsCutout from "../assets/images/temporal/boots-cutout.webp";
import bootsCutoutMin from "../assets/images/temporal/boots-cutout-min.webp";
import bootsBackground from "../assets/images/temporal/boots-background.webp";
import bootsBackgroundMin from "../assets/images/temporal/boots-background-min.webp";
import emmonsCutout from "../assets/images/temporal/emmons-cutout.webp";
import emmonsCutoutMin from "../assets/images/temporal/emmons-cutout-min.webp";
import emmonsBackground from "../assets/images/temporal/emmons-background.webp";
import emmonsBackgroundMin from "../assets/images/temporal/emmons-background-min.webp";
import jeremyScript from "../assets/images/temporal/jeremy-script.webp";
import script from "../assets/images/temporal/script.webp";
import scriptMin from "../assets/images/temporal/script-min.webp";
  ...
  return (
    <div className="page-container">
      <Seo
        ...
        path="/temporal"
        type="video.other"
        description={`"TEMPORAL" is a sci-fi short film that follows a spaceman struggling to survive on a distant alien world after an ion storm brings down his survey ship.`}
      />
      <Hero
