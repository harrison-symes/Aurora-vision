  ...
  return (
    <div>
      <Seo
        title="Our work"
        path="/our-work"
        description="Short films, music videos and commercial work from AuroraVision: Temporal, Things, Outcast, Charm the Wind, Life Been Strange and more, made in Te Whanganui-a-Tara."
      />
      <OurWorkHero />
      {areAllSecretsFound && (
        <>
