  ...
  return (
    <div className="meet-our-crew">
      <div className="meet-our-crew__block">
        <OptimisedImage
          imageUrl="/images/temporal/meet-our-crew-1.png"
          imageUrlSlow="/images/temporal/meet-our-crew-1-min.png"
          alt="meet our crew 1"
      ...
      <div className="meet-our-crew__block meet-our-crew__block--reverse">
        <OptimisedImage
          imageUrl="/images/temporal/meet-our-crew-2.png"
          imageUrlSlow="/images/temporal/meet-our-crew-2-min.png"
        ...
        <div className="meet-our-crew__text-container">
          <p className="meet-our-crew__paragraph">
            ...
            and limited budget - this effort was expertly spearheaded by Aidan
            Falconer. Every detail on screen is a direct result of countless
            hours spent in workshops, studios, and editing rooms by people who
            believed in the story and world we were building.
          </p>
          <p className="meet-our-crew__paragraph">
